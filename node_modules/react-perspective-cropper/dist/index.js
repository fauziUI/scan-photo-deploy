...
var opencvReact = require('opencv-react');
...
var CropPoint = function CropPoint(_ref) {
  ...
  var onStop = React.useCallback(function (_, position) {
...
var CropPoints = function CropPoints(props) {
  ...
  }, otherProps)), /*#__PURE__*/React__default.createElement(CropPoint, _extends({
    pointArea: "right-top",
    defaultPosition: {
      x: previewDims.width,
      y: 0
...
var CropPointsDelimiters = function CropPointsDelimiters(_ref) {
  ...
  var sortPoints = React.useCallback(function () {
...
var Canvas = function Canvas(_ref) {
  ...
  }, previewDims && mode === 'crop' && cropPoints && /*#__PURE__*/React__default.createElement(React.Fragment, null, /*#__PURE__*/React__default.createElement(CropPoints, {
    pointSize: pointSize,
  ...
  }), /*#__PURE__*/React__default.createElement(CropPointsDelimiters, {
    previewDims: previewDims,
    cropPoints: cropPoints,
    lineWidth: lineWidth,
    lineColor: lineColor,
...
var Cropper = React__default.forwardRef(function (props, ref) {
  if (!props.image) {
    return null;
  }
